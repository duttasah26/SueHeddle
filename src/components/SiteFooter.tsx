          ...
          <div className="sp-content" onClick={(e) => e.stopPropagation()}>
            <div className="sp-inner">
              ...
              <div className="sp-socials">
                ...
                <a
                  className="sp-social-btn sp-social-btn--fb"
                ...
                <button
                  className="sp-social-btn sp-social-btn--wc"
                ...
                <a
                  className="sp-social-btn sp-social-btn--em"
              ...
              <div className="sp-url-row">
                ...
                <button
                  ...
                  onClick={copyUrl}
                  aria-label={urlCopied ? "Copied" : "Copy message"}
                >
